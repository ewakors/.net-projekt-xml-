<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site2.Master" CodeBehind= "~/Soup.aspx.cs" Inherits="ksiazkaKucharska.Soup" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3 style="font-weight: normal; padding-top: 3%; margin:0; margin-left: 5%; font-family: 'Dosis', sans-serif; color:black; font-size: 2em;">Zupy:</h3>
    <br/><br/>
    <asp:GridView style="float: left; color:black; margin-right: 10%; margin-left: 5%; " ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="ID" BorderColor="Black" BorderStyle="None" BorderWidth="0px" GridLines="Vertical" HorizontalAlign="Center" ShowFooter="True" Width="400px">
       ...
       <asp:MultiView ID="MultiView1" runat="server" >
        ...
        <div style="overflow:auto;margin-left:50px">
            <br />
            <br />
            <asp:XmlDataSource ID="XmlDataSource1" runat="server" DataFile="~/Soup.xml"></asp:XmlDataSource>

            <asp:XmlDataSource ID="XmlDataSource2" runat="server" DataFile="~/Soup.xml"></asp:XmlDataSource>
